      ...
      <div class="matchList-search-area-base">
        ...
        <div class="matchList-search-area-outerPart">
          ...
          <div class="matchList-search-formArea">
            <form class="matchList-search-form" method="post" action="/matches">
    ...
    <div class="matchList-navigation">
      <div class="matchList-page-selector">
        <div class="matchList-page-button-area">
          <form method="post" action="/matches?page=<c:out value="${page - 1}" /><c:if test = "${filter_by_player_name != null}">&filter_by_player_name=<c:out value="${filter_by_player_name}" /></c:if>" name="prev" >
        ...
        <div class="matchList-page-button-area">
          <form method="post" action="/matches?page=<c:out value="${page + 1}" /><c:if test = "${filter_by_player_name != null}">&filter_by_player_name=<c:out value="${filter_by_player_name}" /></c:if>" name="next" >
